...
$statement = $db->prepare('SELECT * FROM projects WHERE NOT id_entrepreneur = :id');
      ...
      <div class="col-sm-4 py-3 py-sm-0" style="margin-bottom: 30px">
        <div class="card box-shadow">
          ...
          <div class="card-body">
            ...
            <a target="_blank" href="aboutProject.php?id=<?php echo $project['id'];?>" class="btn btn-primary">Contacter</a>
          </div>
        </div>
      </div>
      <?php } ?>
